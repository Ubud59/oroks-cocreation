        ...
        <section>
          <div class="container py-3">
            <div class="card">
              <div class="row ">
                <div class="col-md-4">
                    <img src={require("../../images/fitting_statique.png")} class="w-100" height="50%" width="50%" />
                  </div>
        ...
        <section>
          <div class="container py-3">
            <div class="card">
              <div class="row ">
                <div class="col-md-4">
                    <img src={require("../../images/test_fonction_terrain.png")} class="w-100" height="50%" width="50%" />
                  </div>
                  <div class="col-md-8 px-3">
                    <div class="card-block px-3">
        ...
        <section>
          <div class="container py-3">
            <div class="card">
              <div class="row ">
                <div class="col-md-4">
                    <img src={require("../../images/test_durabilite.png")} class="w-100" height="50%" width="50%" />
                  </div>
                  <div class="col-md-8 px-3">
                    <div class="card-block px-3">
        ...
        <section>
          <div class="container py-3">
            <div class="card">
              <div class="row ">
                <div class="col-md-4">
                    <img src={require("../../images/test_usage.png")} class="w-100" height="50%" width="50%" />
                  </div>
                  <div class="col-md-8 px-3">
                    <div class="card-block px-3">
